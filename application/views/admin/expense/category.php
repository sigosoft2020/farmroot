              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <h2 class="text-uppercase text-center m-b-30">
                          <span><h4>Add Expense Category</h4></span>
                      </h2>
                      <form class="form-horizontal" action="<?=site_url('admin/expense/addCategory')?>" method="post">
                          <div class="form-group m-b-25">
                              <div class="col-12">
                                  <label for="select">Category Name</label>
                                  <input type="text" name="category_name" id="category_name" class="form-control" placeholder="Expense Category" required>
                              </div>
                          </div>
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <form class="form-horizontal" action="<?=site_url('admin/expense/category_update')?>" method="post">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      var dataTable = $('#user_data').DataTable({
        ...
        "order":[],
        "ajax":{
          url:"<?=site_url('admin/expense/get_category')?>",
          type:"POST"
        },
        "columnDefs":[
          {
