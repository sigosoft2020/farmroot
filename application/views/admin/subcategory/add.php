      ...
      <div class="content-page">
        <div class="content">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box">
                <form action="<?=site_url('admin/Subcategory/addData')?>" method="post" id="add-form">
                   ...
                   <div class="row">
                      <div class="col-md-4">
                          <div class="">
                              ...
                              <div>
                                  <p class="mb-1 mt-4 font-weight-bold">Sub Category Name</p>
                                  <input type="text" maxlength="25" name="name" class="form-control" placeholder="Sub Category Name" required>
                              </div>

                              <div>
                                  <p class="mb-1 mt-4 font-weight-bold">Sub Category Image</p>
